...
- Raw extract: `parsers/fooda/extract_fooda_orders_raw.py`
  ...
  - Every Fooda raw extract also parses `Takeout/Mail/Orders-Fooda.mbox` subjects into `data/raw/fooda/orders_company_raw.csv` with `event_number`, `event_date`, and `company_name`.
